...
# Bold italic button
bold_italic_icon = tk.PhotoImage(file='icons2/bold_italic.png')
bold_italic_btn = ttk.Button(tool_bar, image=bold_italic_icon)
bold_italic_btn.grid(row=0, column=9, padx=5)

# Speech to text button
speech_to_text_icon = tk.PhotoImage(file='icons2/microphone.png')
speech_to_text_btn = ttk.Button(tool_bar, image=speech_to_text_icon)
